<? 
   ...
   try{	
	 ...
	 $format2 ="UPDATE weibo SET agree = agree +1 where tid = %s";
	 $format3 ="UPDATE weibo SET flag=1 where tid = %s";
	 $format4 ="UPDATE weibo SET result=0 where tid = %s";
	 $format5 ="insert into evidence(tid,voter_uid,evidence,agree_disagree)values('%s','%s','%s',0)"; 
	 $format6 ="select count(*) from evidence where tid =%s and voter_uid =%s";
	 $format7 ="UPDATE usrinfo SET effective=effective+1 where uid in (select voter_uid from evidence where tid='%s' and agree_disagree=0)";
	 $format8 ="UPDATE usrinfo SET not_effective=not_effective+1 where uid in (select voter_uid from evidence where tid='%s' and agree_disagree=1)";
